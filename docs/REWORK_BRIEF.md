...
| 6.11 | Soak on Blofin demo | Run all 5 test driver scenarios on Blofin demo; audit cleanly before any user moves to production Blofin. **D11 check**: persisted fills/PnL match Blofin's own `trade-history`/`positions-history`, not CP's numbers. |
